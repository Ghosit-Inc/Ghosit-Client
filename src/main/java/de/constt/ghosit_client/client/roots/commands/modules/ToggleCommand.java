        ...
        ModuleManager.getModules().forEach(module -> {
            if(Objects.equals(ModuleAnnotationHelperFunction.getInternalModuleName(module.getClass()), moduleArg)) {
                ...
                if(module.getEnabledStatus()) {
                    ChatHelperFunction.sendCSMessageNeutral(ModuleAnnotationHelperFunction.getName(module.getClass())+" §7(§aon§r§7)", true);
                } else {
                    ChatHelperFunction.sendCSMessageNeutral(ModuleAnnotationHelperFunction.getName(module.getClass())+" §7(§coff§r§7)", true);
                }
            };
        });
    }
