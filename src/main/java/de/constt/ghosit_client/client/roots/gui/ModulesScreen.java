package de.constt.ghosit_client.client.roots.gui;
...
import de.constt.ghosit_client.client.roots.gui.widgets.BlackButtonWidget;
            ...
            this.addDrawableChild(new BlackButtonWidget(x, y, 100, 15, ModuleAnnotationHelperFunction.getName(module.getClass()), button -> {
                ...
                if(Objects.requireNonNull(ModuleManager.getModule(DebuggerModule.class)).getEnabledStatus()) {
                    if (MinecraftClient.getInstance().player != null) {
                        ChatHelperFunction.sendCSMessageNeutral("§8Toggled§r "+ ModuleAnnotationHelperFunction.getName(module.getClass()) + " (" + statusColorCoded + ")", true);
                    }
                }
            }));
